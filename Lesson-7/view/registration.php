    ...
    <div class="container text-center">
        <div class="row">
            <form method="post" class="sign-in-form mt-5 mt-md-5 col-lg-4 col-md-5 col-sm-8">
                ...
                <input type="text" id="username" name="username" class="form-control mt-3" placeholder="Логин для входа" required="" autofocus="">
                ...
                <input type="password" id="password2" name="password2" class="form-control" placeholder="Повторите пароль" required="">
